 ...
 * @author fjzkuroko
 * @version 1.0
 * @datetime 2021/7/25 20:00
 */
public class JWTUtil {

    // token加密时使用的秘钥，一旦得到此秘钥也就可以伪造token了
    private final static String SECRET_KEY = "601mallSecretKey";

    // issuer
    public final static String ISSUER = "601mallissuer";

    // 代表token的有效时间,这里是两个钟 2 * 60 * 60 * 1000
    private final static long KEEP_TIME = 7200000;
     ...
     */
     public static boolean verifyId(String id, HttpServletRequest request) {
         ...
         // 比较token的id和实际传进来的id
         String tokenId = getId(headerToken);
